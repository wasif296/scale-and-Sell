...
export default function Escrow() {
 ...
 { seller: "Ali Hassan", buyer: "Ahmed Khan", amount: "5.0M", status: "Holding", date: "2025-01-15" },
    { seller: "Fatima Ahmed", buyer: "Mohammad Hassan", amount: "2.0M", status: "Pending", date: "2025-01-20" },
    { seller: "Mohammad Khan", buyer: "Zainab Ali", amount: "3.5M", status: "Released", date: "2024-12-10" },
    { seller: "Zainab Ali", buyer: "Omar Khan", amount: "7.0M", status: "Holding", date: "2025-01-18" },
  ]);
  ...
  const handleApprove = (seller: string, buyer: string) => { setEscrowData((prev) =>
      prev.map((item) =>
  ...
  const 
  getStatusBadge = (status: EscrowItem["status"]) => {
    switch (status) {

case "Holding":
        return <Badge color="blue" variant="light">Holding</Badge>;
      case "Pending":
        return <Badge color="yellow" variant="light">Pending</Badge>;
      case "Released":
   return 
    <Badge color="green" variant="light">Released</Badge>;
      default:
